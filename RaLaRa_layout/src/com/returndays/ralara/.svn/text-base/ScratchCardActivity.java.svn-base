...
public class ScratchCardActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mHttpUtil2.getDocument(UrlDef.AD_VIEW_VIEW3, params2, null, new HttpCallBack() {
			...
			public void onHttpCallBackListener(Document document) {
				...
				mScrath_seq ="";
				//Toast.makeText(ScratchViewActivity.this, code, Toast.LENGTH_LONG).show();
				...
				if(code.equals("1")){
					...
					scratchView.setScratchEndListner(new OnScratchEndListner() {
						...
						public void scratchEndListner(int scratchCnt) {
							...
							if(scratchCnt == 170){
								...
								params3.put("ad_seq", ad_seq);

								mHttpUtil3.getDocument(UrlDef.AD_VIEW_VIEW4, params3, null, new HttpCallBack() {
									...
									public void onHttpCallBackListener(Document document) {
										...
										if(rtn.equals("0")){
											...
											Intent intent = new Intent(ScratchCardActivity.this, ScratchResultActivity.class);
											intent.putExtra("ad_seq", ad_seq);
											intent.putExtra("scratch_seq", "");
											intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);

											((Activity)ScratchCardActivity.this).startActivity(intent);
											((Activity)ScratchCardActivity.this).overridePendingTransition(R.anim.fade, R.anim.hold); 
											finish();
										}else{
											Toast.makeText(ScratchCardActivity.this, "네트워크 에러가 발생하였습니다.", Toast.LENGTH_LONG).show();
											finish();
										}
								...
								mHttpUtil3.getDocument(UrlDef.AD_VIEW_VIEW4, params3, null, new HttpCallBack() {
									...
									public void onHttpCallBackListener(Document document) {
										...
										if(rtn.equals("0")){
											...
											Intent intent = new Intent(ScratchCardActivity.this, ScratchResultFailActivity.class);
											intent.putExtra("ad_seq", ad_seq);
											intent.putExtra("scratch_seq", "");
											intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
								...
								mHttpUtil3.getDocument(UrlDef.AD_VIEW_VIEW4, params3, null, new HttpCallBack() {
									...
									public void onHttpCallBackListener(Document document) {
										...
										if(rtn.equals("0")){
											...
											Intent intent = new Intent(ScratchCardActivity.this, ScratchResultAdActivity.class);
											intent.putExtra("ad_seq", ad_seq);
											intent.putExtra("scratch_seq", "");
											intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					...
					Toast.makeText(ScratchCardActivity.this, "이미 스크래치를 한 광고입니다.", Toast.LENGTH_LONG).show();
					finish();

				}else if(code.equals("-9999")){
					Toast.makeText(ScratchCardActivity.this, "에러가 발생하였습니다.", Toast.LENGTH_LONG).show();
					finish();
				}
				else{
					Toast.makeText(ScratchCardActivity.this, "에러가 발생하였습니다.", Toast.LENGTH_LONG).show();
