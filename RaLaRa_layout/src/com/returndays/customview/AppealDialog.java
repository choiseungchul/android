...
public class AppealDialog extends Dialog{
	...
	public AppealDialog(final Activity context) {
		...
		input_desc.setText(R.string.room_appeal_desc);
		edit_content.setHint(R.string.room_appeal_hint);
		mTitle.setText(R.string.room_appeal_title);
